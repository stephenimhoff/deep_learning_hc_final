...
def parse_args():
    ...
    argParser.add_argument('--epochs', default=100, type=int, help='number of epochs to train')
    ...
    argParser.add_argument('--textual-embeddings', default='embeddings/nih_chest_xray_biobert.npy', type=str, help='the path to labels embeddings')
