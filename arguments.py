...
def parse_args():
    ...
    argParser.add_argument('--train-file', default='dataset_splits/train - Copy.txt', type=str, help='the path to train list ')
    ...
    argParser.add_argument('--batch-size', default=4, type=int, help='training batch size')
    argParser.add_argument('--epochs', default=40, type=int, help='number of epochs to train')
    argParser.add_argument('--vision-backbone', default='densenet201', type=str, help='[densenet121, densenet169, densenet201]')
